...
const LeaderBoard = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center overflow-auto scroll-smooth bg-gradient-to-b from-purple-500 via-pink-500 to-red-500 py-[150px]">
      <motion.h1
